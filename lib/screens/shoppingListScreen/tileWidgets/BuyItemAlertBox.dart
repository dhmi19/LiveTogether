...
class BuyItemAlertBox extends StatefulWidget {

  final GroceryItem groceryItem;
  final String apartmentName;
  BuyItemAlertBox({this.groceryItem, this.apartmentName});

  @override
  _BuyItemAlertBoxState createState() => _BuyItemAlertBoxState();
}

class _BuyItemAlertBoxState extends State<BuyItemAlertBox> {
